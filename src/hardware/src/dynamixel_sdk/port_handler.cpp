...
#include "hardware/dynamixel_sdk/port_handler_linux.h"
#elif defined(__APPLE__)
#include "hardware/dynamixel_sdk/port_handler.h"
#include "hardware/dynamixel_sdk/port_handler_mac.h"
#elif defined(_WIN32) || defined(_WIN64)
#define WINDLLEXPORT
#include "hardware/dynamixel_sdk/port_handler.h"
#include "hardware/dynamixel_sdk/port_handler_windows.h"
